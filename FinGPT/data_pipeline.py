...
def main(args):
    ...
    for symbol in tqdm(index):
        ...
        filename = f"{data_dir}/{symbol}_{start_date}_{end_date}.csv" if with_basics \
                else f"{data_dir}/{symbol}_{start_date}_{end_date}_nobasics.csv"
...
if __name__ == "__main__":
    ...
    ap.add_argument("--index_name", default="dow", choices=["dow", "euro", "crypto"], help="index name")
    ap.add_argument("--start_date", default="2023-5-31", help="start date")
    ap.add_argument("--end_date", default="2023-12-31", help="end date")
    ap.add_argument("--min_past_weeks", type=int, default=1, help="min past weeks")
    ap.add_argument("--max_past_weeks", type=int, default=4, help="max past weeks")
    ap.add_argument("--train_ratio", type=float, default=0.6, help="train ratio")
